...
/****************** PRINT_POINTER ******************/
/**
 * print_pointer - PrintsThe valueOf aPointer variable
...
/************************* PRINT_NON_PRINTABLE *************************/
/**
 * print_non_printable - Prints ascii codes in hexa for non printable chars
 ...
 * @precision: PrecisionSpecification
 * @size: SizeSpecifier
 * Return: NumbersOf chars printed
 */
